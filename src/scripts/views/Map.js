...
client.Views.MapView = Backbone.View.extend({
	ol3338: new OpenLayers.Projection('EPSG:3338'),
	ol4326: new OpenLayers.Projection('EPSG:4326'),
	proj3338: '+proj=aea +lat_1=55 +lat_2=65 +lat_0=50 +lon_0=-154 +x_0=0 +y_0=0 +ellps=GRS80 +datum=NAD83 +units=m +no_defs',
	...
	renderBaseLayer: function() {
		...
		this.map = new OpenLayers.Map('map',{
			...
			units:'m',
			wrapDateLine:false,
			projection: this.ol3338,
			displayProjection: this.ol3338,
			controls: []
		});
	...
	coordinateClicked: _.debounce(function(e) {		
		...
		var reprojected = proj4(this.proj3338, this.proj4326, [lonlat.lon, lonlat.lat]);
	...
	drawMarker: function() {
		var reprojected = proj4(this.proj4326, this.proj3338, [this.model.get('lon'), this.model.get('lat')]);
